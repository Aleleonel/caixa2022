...
class MainWindow(QMainWindow):
    ...
    def relatorioFechamentocaixa(self):
        ...
        try:
            ...
            ct = 0
            print("Valor tota dae todas as aberturas do dia ", total_abertura)

            while contador > 0:
                caixa_iniciado = i_valorAbertura[ct]
                total_abertura += i_valorAbertura[ct]
                pdf.drawString(90, 700 - y, str({}).format(caixa_iniciado))
                contador -= 1
                ct += 1
                y += 50
            ...
            pdf.drawString(90, 750 - y, str({}).format(total_abertura))
            pdf.drawString(160, 750 - y, str(total))
            pdf.drawString(220, 750 - y, str(valor_fechamento))
            pdf.drawString(310, 750 - y, str(subtotal))
            pdf.drawString(
                440, 750 - y, str(float(valor_fechamento) - float(subtotal)))
